...
shell = Shell()
shell.run('total', '--', 'gender', force_compile, load, function=True, stage="init")

(msg, P, NN, F, X) = shell.graftask.get_mappings()

stats_file = shell.graftask.add_result("stats.txt")
