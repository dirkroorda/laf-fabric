...
def task(graftask):
    ...
    **Using the annotations**
    ...
    def make_form():
        ...
        outf = graftask.add_result("form_{}={}.txt".format('_'.join(target_types), '_'.join(sorted(new_fnames.keys()))))
    ...
    def make_annots():
        ...
        outa = graftask.add_result("annot_{}={}.xml".format('_'.join(target_types), '_'.join(sorted(new_fnames.keys()))))
